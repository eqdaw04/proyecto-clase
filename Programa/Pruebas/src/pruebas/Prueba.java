...
public class Prueba extends javax.swing.JFrame {
    ...
    public Prueba() {
        ...
        int intAletorio = 1+aleatorio.nextInt(9);
        JOptionPane.showMessageDialog(null, intAletorio);
        System.exit(0);
    }
    ...
    public void blabla(){
        ...
        Calendar fecha = Calendar.getInstance();
            ...
            fecha.set(Calendar.HOUR_OF_DAY, Integer.parseInt("12"));
            fecha.set(Calendar.MINUTE, Integer.parseInt("00"));
            fecha.set(Calendar.SECOND, 0);
            fecha.set(Calendar.MILLISECOND, 0);
        try {
            bdPartido.insertarPartido(fecha);
        } catch (Exception ex) {
